...
func (p PixelFormat) Avcodec_get_chroma_sub_sample(h, v *int) {
...
func (p PixelFormat) Avcodec_pix_fmt_to_codec_tag() uint {
	return uint(C.avcodec_pix_fmt_to_codec_tag((C.enum_AVPixelFormat)(p)))
}

func (p PixelFormat) Avcodec_get_pix_fmt_loss(f PixelFormat, a int) int {
	return int(C.avcodec_get_pix_fmt_loss((C.enum_AVPixelFormat)(p), (C.enum_AVPixelFormat)(f), C.int(a)))
}

//Find the best pixel format to convert to given a certain source pixel format.
func (p *PixelFormat) Avcodec_find_best_pix_fmt_of_list(s PixelFormat, a int, l *int) PixelFormat {
...
func (p PixelFormat) Avcodec_find_best_pix_fmt_of_2(f2, s PixelFormat, a int, l *int) PixelFormat {
