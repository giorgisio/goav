...
const (
	...
	AV_CODEC_ID_ADPCM_VIMA_DEPRECATED       = int(C.AV_CODEC_ID_ADPCM_VIMA_DEPRECATED)
	...
	AV_CODEC_ID_BRENDER_PIX_DEPRECATED      = int(C.AV_CODEC_ID_BRENDER_PIX_DEPRECATED)
	...
	AV_CODEC_ID_ESCAPE130_DEPRECATED        = int(C.AV_CODEC_ID_ESCAPE130_DEPRECATED)
	AV_CODEC_ID_EVRC                        = int(C.AV_CODEC_ID_EVRC)
	AV_CODEC_ID_EXR                         = int(C.AV_CODEC_ID_EXR)
	AV_CODEC_ID_EXR_DEPRECATED              = int(C.AV_CODEC_ID_EXR_DEPRECATED)
	...
	AV_CODEC_ID_G2M_DEPRECATED              = int(C.AV_CODEC_ID_G2M_DEPRECATED)
	...
	AV_CODEC_ID_HEVC_DEPRECATED             = int(C.AV_CODEC_ID_HEVC_DEPRECATED)
	...
	AV_CODEC_ID_MVC1_DEPRECATED             = int(C.AV_CODEC_ID_MVC1_DEPRECATED)
	AV_CODEC_ID_MVC2                        = int(C.AV_CODEC_ID_MVC2)
	AV_CODEC_ID_MVC2_DEPRECATED             = int(C.AV_CODEC_ID_MVC2_DEPRECATED)
	...
	AV_CODEC_ID_OPUS_DEPRECATED             = int(C.AV_CODEC_ID_OPUS_DEPRECATED)
	AV_CODEC_ID_OTF                         = int(C.AV_CODEC_ID_OTF)
	AV_CODEC_ID_PAF_AUDIO                   = int(C.AV_CODEC_ID_PAF_AUDIO)
	AV_CODEC_ID_PAF_AUDIO_DEPRECATED        = int(C.AV_CODEC_ID_PAF_AUDIO_DEPRECATED)
	AV_CODEC_ID_PAF_VIDEO                   = int(C.AV_CODEC_ID_PAF_VIDEO)
	AV_CODEC_ID_PAF_VIDEO_DEPRECATED        = int(C.AV_CODEC_ID_PAF_VIDEO_DEPRECATED)
	...
	AV_CODEC_ID_PCM_S16BE_PLANAR_DEPRECATED = int(C.AV_CODEC_ID_PCM_S16BE_PLANAR_DEPRECATED)
	...
	AV_CODEC_ID_PCM_S32LE_PLANAR_DEPRECATED = int(C.AV_CODEC_ID_PCM_S32LE_PLANAR_DEPRECATED)
	...
	AV_CODEC_ID_SANM_DEPRECATED             = int(C.AV_CODEC_ID_SANM_DEPRECATED)
	AV_CODEC_ID_SGI                         = int(C.AV_CODEC_ID_SGI)
	AV_CODEC_ID_SGIRLE                      = int(C.AV_CODEC_ID_SGIRLE)
	AV_CODEC_ID_SGIRLE_DEPRECATED           = int(C.AV_CODEC_ID_SGIRLE_DEPRECATED)
	...
	AV_CODEC_ID_TAK_DEPRECATED              = int(C.AV_CODEC_ID_TAK_DEPRECATED)
	...
	AV_CODEC_ID_VP7_DEPRECATED              = int(C.AV_CODEC_ID_VP7_DEPRECATED)
	...
	AV_CODEC_ID_WEBP_DEPRECATED             = int(C.AV_CODEC_ID_WEBP_DEPRECATED)
